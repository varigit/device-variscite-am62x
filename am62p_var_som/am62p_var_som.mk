...
$(call inherit-product, device/variscite/am62p_var_som/device.mk)
$(call inherit-product, device/ti/am62x/am62p.mk)

PRODUCT_NAME         := am62p_var_som
PRODUCT_DEVICE       := am62p_var_som
PRODUCT_BRAND        := Variscite
PRODUCT_MODEL        := AOSP on VAR-SOM-AM62P
